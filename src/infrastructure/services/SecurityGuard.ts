 ...
 * 
 * This is an Infrastructure layer service that validates permissions
 * using Forge API. Request-scoped instance to prevent data leakage.
 */
export class SecurityGuard {
    ...
    async validateContext(projectKey: string): Promise<SecurityStatus> {
        ...
        try {
            ...
            console.warn(`[Security] App Browse Check Failed: ${e.message}`);
